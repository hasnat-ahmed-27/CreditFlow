"""
Engine/session bootstrap for the Notification service.
...
Schema strategy: `make_engine(schema="notification")` isolates this service's
...
import models  # noqa: F401 — registers notification_log/known_users/account_recipients
...
def init_db() -> None:
    ...
    if config.DATABASE_URL.startswith("sqlite"):
        ...
        engine = make_engine(schema="notification")

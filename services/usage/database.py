"""
Engine/session bootstrap for the usage/metering service.
...
Schema strategy: `make_engine(schema="usage")` isolates this service's
...
import models  # noqa: F401 — registers usage_ledger/processed_events on Base.metadata
...
def init_db() -> None:
    ...
    if config.DATABASE_URL.startswith("sqlite"):
        ...
        engine = make_engine(schema="usage")

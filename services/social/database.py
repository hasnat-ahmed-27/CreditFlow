"""
Engine/session bootstrap for the Social Publishing service.
...
Schema strategy: `make_engine(schema="social")` isolates this service's
...
import models  # noqa: F401 — registers social_connections/publish_jobs/post_media
...
def init_db() -> None:
    ...
    if config.DATABASE_URL.startswith("sqlite"):
        ...
        engine = make_engine(schema="social")

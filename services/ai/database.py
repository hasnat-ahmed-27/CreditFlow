"""
Engine/session bootstrap for the AI generation service.
...
Schema strategy: `make_engine(schema="ai")` isolates this service's tables
in its own Postgres schema per the spec's schema-per-service rule.
"""
...
import models  # noqa: F401 — registers generation_jobs/prompt_history on Base.metadata
